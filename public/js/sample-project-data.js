...
const SAMPLE_PROJECT_DATA = {
  ...
  materialSubmittals: [
    { 
      sn: 1, 
      item: "نظام إدارة المفاتيح وخزائن الحفظ الذكية – Traka", 
      submissionDate: "2026-01-15", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-11-10", 
      poRequestDate: "2026-02-05", 
      poApprovalDate: "2026-02-22", 
    ...
    { 
      sn: 2, 
      item: "منظومة الهواتف والاتصال المؤسسي IP-Telephony", 
      submissionDate: "2026-02-10", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-10-25", 
      poRequestDate: "2026-03-01", 
      poApprovalDate: "2026-03-18", 
    ...
    { 
      sn: 3, 
      item: "شاشات العرض وجدران الفيديو للمؤتمرات Video Wall Package", 
      submissionDate: "2026-02-22", 
      status: "C", 
      codeName: "Revise & Resubmit", 
      leadTime: "8-10 weeks", 
      requiredSite: "2026-11-05", 
      poRequestDate: "2026-03-10", 
      poApprovalDate: "-", 
      poIssuanceDate: "-", 
    ...
    { 
      sn: 4, 
      item: "أنظمة الصوتيات والمرئيات الاحترافية AV Systems", 
      submissionDate: "2026-02-28", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-10-30", 
      poRequestDate: "2026-03-15", 
      poApprovalDate: "2026-04-02", 
    ...
    { 
      sn: 5, 
      item: "نظام الموسيقى والإذاعة الصوتية العامة BGM Package", 
      submissionDate: "2026-03-05", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-10-20", 
      poRequestDate: "2026-03-20", 
      poApprovalDate: "2026-04-05", 
    ...
    { 
      sn: 6, 
      item: "كابلات التيار الخفيف ومسارات التمديد المقاومة للحريق", 
      submissionDate: "2026-01-05", 
      status: "A", 
      codeName: "Approved", 
      leadTime: "Stock Item", 
      requiredSite: "2026-08-20", 
      poRequestDate: "2026-01-18", 
      poApprovalDate: "2026-01-25", 
    ...
    { 
      sn: 7, 
      item: "نظام التحكم بإضاءة وتكييف المكاتب والغرف GRMS", 
      submissionDate: "2026-05-12", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-11-01", 
      poRequestDate: "2026-05-25", 
      poApprovalDate: "2026-06-10", 
    ...
    { 
      sn: 8, 
      item: "وحدات التغذية الكهربائية غير المنقطعة UPS Systems", 
      submissionDate: "2026-01-20", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-10-28", 
      poRequestDate: "2026-02-12", 
      poApprovalDate: "2026-02-28", 
    ...
    { 
      sn: 9, 
      item: "أقفال الأبواب الذكية وبطاقات الوصول RFID Smart Locks", 
      submissionDate: "2026-03-18", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-10-15", 
      poRequestDate: "2026-04-02", 
      poApprovalDate: "2026-04-20", 
    ...
    { 
      sn: 10, 
      item: "حواجز المداخل الهيدروليكية وبوابات المركبات Security Barriers", 
      submissionDate: "2026-04-10", 
      status: "C", 
      codeName: "Revise & Resubmit", 
      leadTime: "6-8 weeks", 
      requiredSite: "2026-11-20", 
      poRequestDate: "2026-05-02", 
      poApprovalDate: "-", 
      poIssuanceDate: "-", 
    ...
    { 
      sn: 11, 
      item: "كاميرات المراقبة الذكية وخوادم التخزين السحابية AI CCTV & Storage", 
      submissionDate: "2026-04-15", 
      status: "B", 
      codeName: "Approved as Noted", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-11-05", 
      poRequestDate: "2026-05-05", 
      poApprovalDate: "2026-05-24", 
    ...
    { 
      sn: 12, 
      item: "مفاتيح الشبكات والموجهات الأساسية Core & Edge Network Switches", 
      submissionDate: "2026-05-20", 
      status: "C", 
      codeName: "Revise & Resubmit", 
      leadTime: "8-12 weeks", 
      requiredSite: "2026-11-01", 
      poRequestDate: "2026-06-01", 
      poApprovalDate: "-", 
      poIssuanceDate: "-", 
